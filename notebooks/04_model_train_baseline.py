...
print(f"  XGBoost   Val  RMSE={xgb_results['RMSE']:.4f}  MAE={xgb_results['MAE']:.4f}  R²={xgb_results['R2']:.4f}")
if xgb_test_results:
    print(f"  XGBoost   Test RMSE={xgb_test_results['RMSE']:.4f}  MAE={xgb_test_results['MAE']:.4f}  R²={xgb_test_results['R2']:.4f}")
print(f"  LightGBM  Val  RMSE={lgb_results['RMSE']:.4f}  MAE={lgb_results['MAE']:.4f}  R²={lgb_results['R2']:.4f}")
if lgb_test_results:
    print(f"  LightGBM  Test RMSE={lgb_test_results['RMSE']:.4f}  MAE={lgb_test_results['MAE']:.4f}  R²={lgb_test_results['R2']:.4f}")
print(f"  Ensemble  Val  RMSE={ens_results['RMSE']:.4f}  MAE={ens_results['MAE']:.4f}  R²={ens_results['R2']:.4f}")
if ens_test_results:
    print(f"  Ensemble  Test RMSE={ens_test_results['RMSE']:.4f}  MAE={ens_test_results['MAE']:.4f}  R²={ens_test_results['R2']:.4f}")
print()
